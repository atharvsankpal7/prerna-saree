...
export default function CustomerReviewsSection({ reviews }: CustomerReviewsSectionProps) {
    ...
    const displayReviews = reviews.length > 0 ? reviews : [
        { _id: '1', rating: 5, comment: 'The quality and detailing are outstanding. Truly elegant sarees.', userName: 'Savita Jadhav', createdAt: new Date().toISOString() },
        { _id: '2', rating: 5, comment: 'Absolutely loved the fabric and the beautiful border work. Perfect for any occasion.', userName: 'Priya Sharma', createdAt: new Date().toISOString() },
        { _id: '3', rating: 5, comment: 'Exceptional craftsmanship! The customization options made it so special and unique.', userName: 'Anita Desai', createdAt: new Date().toISOString() },
    ];
